...
model = "claude-3-5-haiku-latest" #"grok-beta" #os.getenv("OPENAI_MODEL")
...
claude_system_prompt = """<artifacts_info>
...
def generate_openai_response(messages, max_tokens=2000, response_format=None):
    try:
...
completion = generate_openai_response(
    [
        {
            "role": "system", 
